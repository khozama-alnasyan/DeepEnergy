...
final_results_df.to_excel('results/cnn_lstm_32_all_results.xlsx', index=False)
print("Results saved to 'results/cnn_lstm_32_all_results.xlsx'.")
...
results_df.to_excel('results/cnn_lstm_32_predictions.xlsx', index=False)
print("Final predictions saved to 'results/cnn_lstm_32_predictions.xlsx'.")
