...
final_results_df.to_excel('results/lstm_64_all_results.xlsx', index=False)
print("\nAll evaluation metrics saved to 'results/lstm_64_all_results.xlsx'.")
...
results_df.to_excel('results/lstm_64_predictions.xlsx', index=False)
print("\nPredictions saved to 'results/lstm_64_predictions.xlsx'.")
