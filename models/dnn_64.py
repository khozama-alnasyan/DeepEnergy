...
final_results_df.to_excel('results/dnn_64_all_results.xlsx', index=False)
print("\nAll results have been saved to 'results/dnn_64_all_results.xlsx'.")
...
results_df.to_excel('results/dnn_64_predictions.xlsx', index=False)
print("\nPredictions saved to 'results/dnn_64_predictions.xlsx'.")
